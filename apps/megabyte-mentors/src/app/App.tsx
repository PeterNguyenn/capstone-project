          ...
          <View style={styles.section}>
            <View style={styles.shadowBox}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  Linking.openURL('https://cloud.nx.app/connect/AZ5xW9h64B');
                }}
              >
                <Text
                  style={[
          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                >
                  nx test MegabyteMentors
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Lint
                </Text>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx lint MegabyteMentors
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Run them together!
                </Text>
                ...
                >
                  nx run-many -p MegabyteMentors -t build test lint
                </Text>
              </View>
              ...
              <View style={[styles.codeBlock, styles.marginBottomLg]}>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx show project MegabyteMentors
                </Text>
              </View>
              <View style={styles.listItem}>
                <Svg
